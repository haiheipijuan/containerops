...
// TableName is return the table name of Workflow in database.
func (r *Workflow) TableName() string {
	return "workflow"
}

// Return *gorm.DB with table Workflow
func GetWorkflow() *gorm.DB {
